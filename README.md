...
# SFT-General-Simplified.Chinese-10K 概况介绍（GitHub版）

GitHub仓库：`OysterCore/SFT-General-Simplified.Chinese-10K`

Hugging Face数据集：`OysterCoreAI/SFT-General-Simplified.Chinese-10K`
...
dataset = load_dataset("OysterCoreAI/SFT-General-Simplified.Chinese-10K")
print(dataset)
